...
wget https://frostt-tensors.s3.us-east-2.amazonaws.com/FB-M/fb-m.tns.gz 
...
wget https://s3.us-east-2.amazonaws.com/frostt/frostt_data/lbnl-network/lbnl-network.tns.gz 
...
wget https://s3.us-east-2.amazonaws.com/frostt/frostt_data/vast-2015-mc1/vast-2015-mc1-3d.tns.gz 
wget https://s3.us-east-2.amazonaws.com/frostt/frostt_data/vast-2015-mc1/vast-2015-mc1-5d.tns.gz 

gzip -d nell-1.tns.gz
gzip -d chicago-crime-comm.tns.gz
gzip -d chicago-crime-geo.tns.gz
gzip -d amazon-reviews.tns.gz
gzip -d delicious-3d.tns.gz
gzip -d delicious-4d.tns.gz
gzip -d enron.tns.gz
gzip -d fb-m.tns.gz
gzip -d flickr-4d.tns.gz
gzip -d flickr-3d.tns.gz 
gzip -d lbnl-network.tns.gz
gzip -d nips.tns.gz
gzip -d patents.tns.gz
gzip -d reddit-2015.tns.gz
gzip -d uber.tns.gz 
gzip -d vast-2015-mc1-3d.tns.gz
gzip -d vast-2015-mc1-5d.tns.gz